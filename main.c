	...
	while (SDL_WaitEvent(&ChessMove))
	{
		...
		case SDL_MOUSEBUTTONUP:
			if (player == 1)
			{
				...
				{
					int a = ChessPointNow.yellow1[0], b = ChessPointNow.yellow1[1];
					JudgeChess(&ChessPointNow.yellow1[0], &ChessPointNow.yellow1[1], result);
					if (a == ChessPointNow.yellow1[0] && b == ChessPointNow.yellow1[1])
